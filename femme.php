...
function getAllfemme($pdo)
{
    $requette = "SELECT * FROM produitfemme";
    $resultat = $pdo->query($requette);
    $produitfemme = $resultat->fetchAll();
    return $produitfemme;
}

// Usage example
$pdo = new PDO("mysql:host=localhost;dbname=sport", "root", "");
$data = getAllfemme($pdo);
...
<section class="products" id="products">
    <div class="box-container">
        <?php foreach ($data as $produitfemme) { ?>
            <div class="box">
                <div class="icons">
                    <a href="#" class="fas fa-heart"></a>
                </div>
                <img src="images/<?php echo $produitfemme['image']; ?>" alt="<?php echo $produitfemme['nom']; ?>">
                <div class="content">
                    <h3>
                        <?php echo $produitfemme['nom']; ?>
                    </h3>
                    <div class="price">
                        <p>
                            <?php echo $produitfemme['prix']; ?>
                        </p>
                        <a style="color:black; background-color:rgb(214, 175, 127); ;" href="panier.php"
                            class="btn">Acheter</a>
